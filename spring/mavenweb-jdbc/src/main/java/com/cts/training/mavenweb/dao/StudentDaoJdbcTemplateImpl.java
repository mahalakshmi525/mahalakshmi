...
public class StudentDaoJdbcTemplateImpl implements IStudentDao {
	...
	private final String SQL_INSERT = "insert into student(name,email,age,salary) values(?, ?,?,?)";
	private final String SQL_UPDATE = "update student set name=?, email=?,age=?,salary=? where id=?";
	...
	public boolean add(Student student) {
		// TODO Auto-generated method stub
		int n = this.jdbcTemplate.update(this.SQL_INSERT, new Object[] {student.getName(), student.getEmail(),student.getAge(),student.getSalary()});
	...
	public boolean update(Student student) {
		// TODO Auto-generated method stub
		int n = this.jdbcTemplate.update(this.SQL_UPDATE, new Object[] {student.getName(), student.getEmail(), student.getId(),student.getAge(),student.getSalary()});
		// n : number of rows affected
		if(n>0)
			return true;
		return false;
