...
<body>
<spring-form:form action="${pagecontext.request.contextpage}/student/save-update" method="POST" modelattribute="student">
	...
	<br/>
	<br/>
	<spring-form:label path="age">Age : </spring-form:label>
	<spring-form:input path="age"/>
	<br/>
	<br/>
	<spring-form:label path="salary">salary : </spring-form:label>
